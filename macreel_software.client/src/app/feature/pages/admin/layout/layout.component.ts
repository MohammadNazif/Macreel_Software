  ...
  menus = [
    ...
    },
    {
      ...
      children: [
        {
          label: 'Add Employee',
          route: '/home/admin/add-employee', roles: ['admin','manager']
        },
        {
          label: 'Employee List',
          route: '/home/admin/employee-list', roles: ['admin','manager']
        }
      ]
    },
    {
      ...
      roles: ['admin','hr','manager'],
      children: [
        { label: 'Assign Leave', route: '/home/admin/assign-leave', roles: ['admin','manager'] },
        { label: 'Assigned Leaves', route: '/home/admin/assigned-employees-leaves', roles: ['admin','manager'] },
        { label: 'Leave Request', route: '/home/admin/leave-requests', roles: ['admin','manager'] }
      ]
    },
    {
