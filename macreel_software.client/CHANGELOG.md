...
- Create Angular project with ng: `ng new macreel_software.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`macreel_software.client.esproj`).
